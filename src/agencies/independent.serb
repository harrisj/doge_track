...
- A DOGE team (usually led by {% person_link('Cavanaugh') %}) then makes contact with the agency, usually under the usual pretenses of "IT modernization" and convinces/threatens them to sign an <abbr title="Memorandum of Understanding">MOU</abbr> detailing DOGE to the agency
